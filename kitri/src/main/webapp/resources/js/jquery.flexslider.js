...
;(function ($) {
  ...
  $.flexslider.defaults = {
    ...
    prevText: "<div style='width:50%; height:600px; position:absolute; left:0px;' onmouseover=show_roll_btns('left') onmouseleave=hide_roll_btns('left')><img src='/images/btn/roll_left.png' id='roll_left' class='roll_btns' style='position:absolute; left:400px; top:250px; z-index:+999;' border=0></div>",           //String: Set the text for the "previous" directionNav item
    nextText: "<div style='width:50%; height:600px; position:absolute; right:0px;' onmouseover=show_roll_btns('right') onmouseleave=hide_roll_btns('right')><img src='/images/btn/roll_right.png' id='roll_right' class='roll_btns' style='position:absolute; right:400px; top:250px; z-index:+999;' border=0></div>",               //String: Set the text for the "next" directionNav item
